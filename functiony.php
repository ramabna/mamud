...
$header[] = "X-Location: -7.80123".mt_rand(100,999).",110.38".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: 5.595372,108.671736";
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -5.157986171333407,119.4499203427434";
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -6.93".mt_rand(100,999).",107.60".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: 1.13".mt_rand(100,999).",104.05".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -8.346206,118.217118";
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -6.714166,116.130284";
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
class ydf
{
    ...
    $karakter2 = '123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0';
